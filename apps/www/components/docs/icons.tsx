...
const addedIcons = [
...

  {
    ...
    icons: [
      ...
      'icons-align-end-horizontal',
      'icons-align-end-vertical',
      'icons-align-horizontal-distribute-center',
      'icons-align-start-horizontal',
      'icons-align-start-vertical',
      'icons-align-vertical-distribute-center',
      'icons-archive',
      'icons-book',
      'icons-book-open',
      'icons-calendar',
