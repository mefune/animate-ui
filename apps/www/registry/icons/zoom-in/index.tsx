...
type ZoomInProps = IconProps<keyof typeof animations>;
...
function IconComponent({ size, ...props }: ZoomInProps) {
...
function ZoomIn(props: ZoomInProps) {
...
export {
  ...
  type ZoomInProps,
  type ZoomInProps as ZoomInIconProps,
};
